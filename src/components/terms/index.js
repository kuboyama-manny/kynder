...
const Terms = () => {
  return (
    <div className="terms-container">
      <CommonHeader edit title="Terms Of Use" />
      <div className="terms-wrapper">
        <div className="terms-content">
          <p className="sub-title">AGREEMENT TO TERMS</p>
          <p className="description bold">
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity
            (“you”) and kynder company ltd ("Company", “we”, “us”, or
            “our”), concerning your access to and use of the <span>kynder.co.uk</span>
          ...
          <p className="sub-title">INTELLECTUAL PROPERTY RIGHTS</p>
          <p className="description bold">
          ...
          <p className="sub-title">USER REPRESENTATIONS</p>
          <p className="description bold">
            ...
            not use the Site for any illegal or unauthorised purpose; and (8)
          ...
          <p className="sub-title">USER REGISTRATION</p>
          <p className="description bold">
          ...
          <p className="sub-title">PROHIBITED ACTIVITIES</p>
          <p className="description bold">
          ...
          <p className="description bold sub">
          ...
          <p className="description bold sub">
            23. Make any unauthorised use of the Site, including collecting
          ...
          <p className="sub-title">USER GENERATED CONTRIBUTIONS</p>
          <p className="description bold">
          ...
          <p className="description bold sub">
            ...
            to authorise us, the Site, and other users of the Site to use your
          ...
          <p className="sub-title">CONTRIBUTION LICENSE</p>
          <p className="description bold">
          ...
          <p className="sub-title">MOBILE APPLICATION LICENSE</p>
          <p className="description bold">
            Use License
          </p>
          <p className="description bold">
            ...
            in these Terms of Use. You shall not: (1) decompile, reverse
          ...
          <p className="description bold">
            ...
            license to use the application on a device that utilises the Apple
          ...
          <p className="sub-title">SUBMISSIONS</p>
          <p className="description bold">
          ...
          <p className="sub-title">THIRD-PARTY WEBSITE AND CONTENT</p>
          <p className="description bold">
          ...
          <p className="sub-title">SITE MANAGEMENT</p>
          <p className="description bold">
          ...
          <p className="description bold">
            ...
            to the United Kingdom, and you agree to have your data transferred
            to and processed in the United Kingdom.
          </p>
          <p className="sub-title">TERM AND TERMINATION</p>
          <p className="description bold">
          ...
          <p className="sub-title">MODIFICATIONS AND INTERRUPTIONS</p>
          <p className="description bold">
          ...
          <p className="sub-title">GOVERNING LAW</p>
          <p className="description bold">
            ...
            country of residence. kynder company ltd and yourself both agree
            to submit to the non-exclusive jurisdiction of the courts
            of London, which means that you may make a claim to defend your
          ...
          <p className="description bold">
            ...
            platform, which you can access here:&nbsp;<span>https://ec.europa.eu/consumers/odr</span>&nbsp;
            . If you would like to bring this subject to our attention, please
            contact us.
          </p>
          <p className="sub-title">CORRECTIONS</p>
          <p className="description bold">
          ...
          <p className="sub-title">DISCLAIMER</p>
          <p className="description bold">
          ...
          <p className="sub-title">LIMITATIONS OF LIABILITY</p>
          <p className="description bold">
            ...
            US DURING THE TWO (2) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION
          ...
          <p className="sub-title">INDEMNIFICATION</p>
          <p className="description bold">
          ...
          <p className="sub-title">USER DATA</p>
          <p className="description bold">
          ...
          <p className="sub-title">MISCELLANEOUS</p>
          <p className="description bold">
          ...
          <p className="description bold">
            User agrees to not claim payment back once donated to the
            nominated foundation or beneficiary.
          </p>
